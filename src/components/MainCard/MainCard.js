...
const MainCard = () => {
  ...
  return (
    ...
    <div className='cardcontainer'>
        ...
        <div className='hidecard'>
        <CardItem className="carditem"  title="MUST-HAVE SMARTPHONE" para="smartphone to tablet"imgurl="https://images.unsplash.com/photo-1496345962527-29757c3a3d94?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" />
        </div>
    </div>
