...
import { addToCart } from '../store-redux/actions';
...
const ProductPage = () => {
  ...
  const getThePruddcta = ProductListFromState.find(
  ...
  if (!getThePruddcta) {
    return <div>{<Navigate to="/Pagenotfound" replace={true} />}</div>;
  }
    ...
    <div className="productPageContainer">
      ...
      <div className="descContainer">
        <div className="desHeadline">
          ...
          <p className="descParagrape">
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum is that it has a more-or-less normal
            distribution of letters, as opposed toIt is a long established fact
        ...
        <div className="btnContainer">
          <button onClick={addToCartHandel} className="prodcutpageATC">
            ADD TO CART
          </button>
        </div>
